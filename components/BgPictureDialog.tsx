...
import { removeBgImage, uploadBgImage } from "../apis/services/profile";
...
const BgPictureDialog = ({
  ...
  const handleUploadButtonClick = () => {
    ...
    uploadBgImage(formData).then(() => {
      dispatchToast({
        type: TypesToast.SHOW_TOAST,
        payload: {
          message: 'Background image has been updated successfully',
          type: 'success',
        },
      });
    }).catch(() => {
          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                {!!imgSrc && <div className="mt-4 mx-auto w-full min-h-[300px] max-h-[500]">
                  <img src={imgSrc || ''} className="w-full h-full"></img>
                </div>}
...
export default BgPictureDialog;